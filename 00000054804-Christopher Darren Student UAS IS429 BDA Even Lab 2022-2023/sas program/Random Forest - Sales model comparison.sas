...
proc casutil;
  Load casdata="model comparison.sashdat" incaslib="Models" casout="model comparison" outcaslib="casuser" replace;
Quit;
...
proc cas;
  ...
  routineCode = "
   ...
   Generated SAS Scoring Code
     ...
     ------------------------------------------*/
declare object model comparison(astore);
call model comparison.score('CASUSER','model comparison');
   /*------------------------------------------*/
   /*_VA_DROP*/ drop 'P_Sales'n;
      'P_Sales_11686'n='P_Sales'n;
   /*------------------------------------------*/
";
